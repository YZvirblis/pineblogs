...
const sideBtn = styled.button`
  ...
  -webkit-box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.94);
  ...
  justify-content: center;
  margin: 1vh;
  border-top-right-radius: ${(props) => props.small && "50%"};
  border-bottom-right-radius: ${(props) => props.small && "50%"};
  border-bottom-left-radius: ${(props) => props.small && "50%"};
`;
...
export {
  ...
  CreatePostInput,
  PostTagsInput,
  PostTagsInputContainer,
  TagContainer,
  TagsContainer,
  IconsContainer,
  styledIcon,
  commentsSection,
  wrightCommentWrapper,
  wrightCommentInput,
  commentButton,
  commentWrapper,
  sideBtn,
  postSideBtnsContainer,
  postContent,
};
